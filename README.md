...
- una pagina prodotti, con una tabella di prodotti (vini, olii, formaggi, miele) di loro produzione 
    - ogni singolo prodotto: id, nome, categoria (vino, olio, formaggio. miele), sottocategoria (vino rosso, vino bianco, olio EVO, olio aromatizzato, formaggio stagionato, formaggio morbido, miele d'acacia, miele millefiori), quantità (litri, grammi...), disponibilità (se true "disponibile"; se <=5 "disponibilità limitata"; altrimenti "non disponibile"), prezzo, immagine
